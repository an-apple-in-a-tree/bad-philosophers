...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center px-24 bg-[#F7F2E9] text-[#2B292B]">
      <div className="relative h-[500px] mb-12 w-screen overflow-hidden rounded-lg">
      ...
      <div className="w-screen h-[12px] bg-gold mt-20 mb-6 rounded-lg"></div>

      <div className="flex items-center justify-center mt-32">
        <div className="h-[12px] w-[200px] bg-dim w-full mx-8 rounded-lg"></div>
        <span
      ...
      <div className="w-screen h-[12px] bg-gold"></div>
      ...
      <div className="flex w-full">
        ...
        <div className="h-96 w-full rounded-2xl bg-white mb-16">
          <p className="p-8 text-4xl">
            ...
            conversations with chatbots embodying the world's forgotten schools
            of thought.
          </p>
        </div>
      </div>
